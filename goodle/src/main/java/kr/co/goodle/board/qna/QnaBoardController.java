...
public class QnaBoardController {
	...
	private final static Logger logger = LoggerFactory.getLogger(QnaBoardController.class);
	...
	public String writeForm() {
		return "/board/qnaboard/write_form";//jsp file name
	}//writeForm
	...
	public String list( Model model, String userWantPage, SearchDTO dto ) {
		...
		return "/board/qnaboard/qnalist";//jsp file name
