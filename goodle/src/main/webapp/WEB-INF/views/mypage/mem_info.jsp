    ...
    <div class="container py-4 py-xl-5">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2 class="font-weight-bold">프로필 관리</h2>
            </div>
        </div>
            ...
            <div class="col mb-4">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" src="${pageContext.request.contextPath}/resources/dashboard/assets/img/profile.png">
                    <div class="card-body p-4">
                        ...
                        <h4 class="font-weight-bold card-title">개인정보 관리</h4>
<!--                         <p class="card-text">간편하고 안정하게 개인정보를 수정해보세요. 배송지와 선호도까지 수정할 수 있습니다</p> -->
                        <a class="small text-black stretched-link" href="${pageContext.request.contextPath}/mypage/profile_man"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col mb-4">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" src="${pageContext.request.contextPath}/resources/dashboard/assets/img/apple.png">
                    <div class="card-body p-4">
                        ...
                        <h4 class="font-weight-bold card-title">선호도 관리</h4>
<!--                         <p class="card-text">맞춤 설정된 레시피들이 추천 됩니다. </p> -->
                        <a class="small text-black stretched-link" href="${pageContext.request.contextPath}/mypage/preference_man"></a>
            ...
            <div class="col mb-4">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" src="${img_src}/receipt.png">
                    <div class="card-body p-4">
                        ...
                        <h4 class="font-weight-bold card-title">결제정보 관리</h4>
<!--                         <p class="card-text">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p> -->
                        <a class="small text-black stretched-link" href="${pageContext.request.contextPath}/mypage/payment_man"></a>
                    </div>
                </div>
            </div>
        </div>
