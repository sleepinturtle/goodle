        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form>
                    ...
                    <div class="form-group"><label>답변</label><textarea id="answer" class="form-control rows="5">${detail_dto.answer}</textarea></div>
<!--                     <button class="btn btn-light" type="button">Send </button> -->
	...
	$(document).ready(function() {
		$("#write_btn").click(function() {
			...
			$.post(
					"${pageContext.request.contextPath}/manager/qna/write"
					, {
						title1 : $("#title1").val()
					...
					, function(data, status) {
						if(data >= 1){
							...
							location.href="${pageContext.request.contextPath}/manager/qna/list";
						} else if(data <= 0){
